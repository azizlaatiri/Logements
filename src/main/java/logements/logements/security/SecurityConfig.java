    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/logements/*/indisponibilites").hasRole("HOTE")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/logements/mes-logements").hasRole("HOTE")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/logements/*/reservations/recurrentes").authenticated()
